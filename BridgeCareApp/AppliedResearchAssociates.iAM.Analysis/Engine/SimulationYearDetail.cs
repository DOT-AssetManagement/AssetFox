...
/// <summary>
///     Results for a time period increment (i.e. a year) in a scenario.
/// </summary>
public sealed class SimulationYearDetail
{
    ...
    /// <summary>
    ///     List of the average target conditions the simulation is trying to achieve in this time period.
    /// </summary>
