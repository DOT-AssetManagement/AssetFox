...
namespace AppliedResearchAssociates.iAM.DataPersistenceCore.Repositories
{
    public interface ISelectableTreatmentRepository
    {
        ...
        List<TreatmentDTO> GetScenarioSelectableTreatmentsForReport(Guid simulationId);
        ...
        List<TreatmentDTOWithSimulationId> GetAllScenarioTreatmentBySimulationId(Guid simulationId);
