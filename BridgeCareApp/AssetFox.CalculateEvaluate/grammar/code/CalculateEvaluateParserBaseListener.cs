...
public partial class CalculateEvaluateParserBaseListener : ICalculateEvaluateParserListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterNumberReference([NotNull] CalculateEvaluateParser.NumberReferenceContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitNumberReference([NotNull] CalculateEvaluateParser.NumberReferenceContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterComparisonOperand([NotNull] CalculateEvaluateParser.ComparisonOperandContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="CalculateEvaluateParser.comparisonOperand"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitComparisonOperand([NotNull] CalculateEvaluateParser.ComparisonOperandContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterLiteral([NotNull] CalculateEvaluateParser.LiteralContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="CalculateEvaluateParser.literal"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitLiteral([NotNull] CalculateEvaluateParser.LiteralContext context) { }
