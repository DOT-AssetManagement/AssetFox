...
{
    public class ClosedBridgeDeckAreaByBPN
    {
        ...
        internal void Fill(ExcelWorksheet worksheet, ExcelWorksheet bridgeWorkSummaryWorkSheet, int totalClosedBridgeDeckAreaByBPNYearsRow, int simulationYearsCount)
        {
