...
namespace BridgeCare.Services.SummaryReport.WorkSummary
{
    public class BridgesCulvertsWorkSummary
    {
        ...
        public void FillBridgesCulvertsWorkSummarySections(ExcelWorksheet worksheet, CurrentCell currentCell, List<int> simulationYears, SortedSet<SimulationDataModel> simulationDataModels, List<string> treatments)
        {
        ...
        private void FillNumberOfCulvertsWorkedOnSection(ExcelWorksheet worksheet, CurrentCell currentCell, List<int> simulationYears, SortedSet<SimulationDataModel> simulationDataModels, ProjectRowNumberModel projectRowNumberModel, List<string> treatments)
        {
        ...
        private void AddCountsOfCulvertsWorkedOn(ExcelWorksheet worksheet, SortedSet<SimulationDataModel> simulationDataModels, List<int> simulationYears, CurrentCell currentCell, ProjectRowNumberModel projectRowNumberModel, List<string> treatments)
        {
        ...
        private void FillNumberOfBridgesWorkedOnSection(ExcelWorksheet worksheet, CurrentCell currentCell, List<int> simulationYears, SortedSet<SimulationDataModel> simulationDataModels, ProjectRowNumberModel projectRowNumberModel, List<string> treatments)
        {
        ...
        private void AddCountsOfBridgesWorkedOn(ExcelWorksheet worksheet, SortedSet<SimulationDataModel> simulationDataModels, List<int> simulationYears, CurrentCell currentCell, ProjectRowNumberModel projectRowNumberModel, List<string> treatments)
        {
            int startRow, startColumn, row, column;
            bridgeWorkSummaryCommon.SetRowColumns(currentCell, out startRow, out startColumn, out row, out column);
