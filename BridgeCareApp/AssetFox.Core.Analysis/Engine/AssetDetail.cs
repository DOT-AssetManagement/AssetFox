...
/// <summary>
///     Represents the state of a specific asset in the simulation, usually as part of an array
///     representing the state of the selected network at the end of a specific cycle.
/// </summary>
