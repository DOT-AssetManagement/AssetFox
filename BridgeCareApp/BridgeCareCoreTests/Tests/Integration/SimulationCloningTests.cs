...
using AssetFox.Core.UnitTestsCore.Tests.BudgetPriority;
using AssetFox.Core.UnitTestsCore.Tests.CashFlowRule;
using AssetFox.Core.UnitTestsCore.Tests.RemainingLifeLimit;
...
using AssetFox.Core.UnitTestsCore.Tests.SimulationCloning;
...
using AssetFox.Core.UnitTestsCore.Tests.TreatmentSupersedeRule;
...
namespace AssetFoxCoreTests.Tests.Integration
{
    ...
    public class SimulationCloningTests
    {
        ...
        public async Task SimulationInDbWithCalculatedAttributeWithCriterionLibrary_Clone_Clones()
        {
            ...
            Assert.NotEqual(calculatedAttribute.Equations[0].Id, clonedAttribute.Equations[0].Id);
            Assert.NotEqual(calculatedAttribute.Equations[0].Equation.Id, clonedAttribute.Equations[0].Equation.Id);
            var originalLibrary = calculatedAttribute.Equations[0].CriteriaLibrary;
        ...
        public void SimulationInDbWithBudgetWithAmountAndCommittedProject_Clone_Clones()
        {
            ...
            var originalProject = originalProjects.Single();
