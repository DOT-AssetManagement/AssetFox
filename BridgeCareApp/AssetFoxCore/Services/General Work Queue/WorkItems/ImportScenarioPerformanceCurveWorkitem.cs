...
namespace BridgeCareCore.Services.General_Work_Queue.WorkItems
{
    ...
    {
        public string WorkId => WorkQueueWorkIdFactory.CreateId(SimulationId, WorkType.ImportScenarioPerformanceCurve);
        ...
        public void OnFault(IServiceProvider serviceProvider, string errorMessage)
        {
            ...
            _hubService.SendRealTimeMessage(UserId, HubConstant.BroadcastError, $"{PerformanceCurveController.DeteriorationModelError}::ImportScenarioPerformanceCurvesExcelFile - Something was wrong with the provided file");
        }
