...
using WorkSummaryByBudgetModel = AssetFox.Core.Reporting.Models.PAMSSummaryReport.WorkSummaryByBudgetModel;
using YearsData = AssetFox.Core.Reporting.Models.PAMSSummaryReport.YearsData;
