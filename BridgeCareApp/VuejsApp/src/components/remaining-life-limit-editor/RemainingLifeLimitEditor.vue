                    ...
                    <tr :active="props.item.selected" @click="props.item.selected = !props.item.selected">
                        ...
                        <td class="px-0">
                            <v-btn id="RemainingLifeLimitEditor-editCriteria-vbtn" @click="onShowCriterionLibraryEditorDialog(props.item)" 
                                class="ghd-blue" style="padding-top: 13px;" flat icon>
...
import DeleteSelectedButton from '@/shared/components/buttons/DeleteSelectedButton.vue';
    ...
    function selectRemainingLifeLimitLibraryAction(payload?: any){store.dispatch('selectRemainingLifeLimitLibrary', payload)}
