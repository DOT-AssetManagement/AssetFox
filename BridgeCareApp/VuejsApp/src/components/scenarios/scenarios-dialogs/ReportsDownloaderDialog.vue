...
export default class ReportsDownloaderDialog extends Vue {
    ...
    @Action('clearSummaryReportMissingAttributes')
    clearSummaryReportMissingAttributesAction: any;
    ...
    onMissingSummaryReportAttributesChanged() {
        this.showMissingAttributesMessage = hasValue(
            this.missingSummaryReportAttributes,
        );
    }
                        ...
                        case 'Condition Result Report': {
                            await ReportsService.downloadConditionResultReport(
                                ...
                                if (response == undefined) {
                                    this.setErrorMessageAction({
                                        message:
                                            'Condition result report does not exists on the target path. Please generate the report before downloading',
                                    });
                                } else {
                                    this.setSuccessMessageAction({
                                        message: 'Report has been downloaded',
    ...
    async generateSummaryReport() {
        await ReportsService.getSummaryReport(this.selectedScenarioData).then(
