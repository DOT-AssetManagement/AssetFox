            ...
            >
                <v-list class="pt-0" dense>
                    ...
                    <v-list-group prepend-icon="fas fa-book">
                        ...
                        <v-list-tile
                            @click="onNavigate('/PerformanceEditor/Library/')"
                        >
                        ...
                        <v-list-tile
                            @click="onNavigate('/PriorityEditor/Library/')"
                        >
                            <v-list-tile-title>Priority</v-list-tile-title>
                        </v-list-tile>
                        <v-list-tile
                            @click="onNavigate('/TargetEditor/Library/')"
                        >
                            <v-list-tile-title>Target</v-list-tile-title>
                        </v-list-tile>
                        <v-list-tile
                            @click="onNavigate('/DeficientEditor/Library/')"
                        >
                        ...
                        <v-list-tile
                            @click="
                                onNavigate('/CriteriaLibraryEditor/Library/')
                            "
                        >
...
export default class AppComponent extends Vue {
    ...
    created() {
        ...
        this.$router.beforeEach((to: any, from: any, next: any) => {
            ...
            const showAlert: boolean =
                !this.pushRouteUpdate && this.hasUnsavedChanges;
            if (showAlert) {
    ...
    async onJobQueue() {
        await ReportsService.getJobList().then(
